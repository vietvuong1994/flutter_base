...
class GetListSongTopAPI: APIOperation<GetSongNewResponse> {
    ...
    init(size: Int? = nil) {
        ...
        super.init(request: APIRequest(name: "API0003 ▶︎ Get list song top home.",
                                       path: "song/top-100",
                                       method: .get,
...
struct GetListSongTopResponse: APIResponseProtocol {
