...
struct Constants {
    ...
    static let defaultImage = UIImage(named: "img_load_default")
    ...
    static var API_BASE_URL = "http://upload.djcloud.vn";
    
    static var GOOGLE_iOS_CLIENT_ID: String {
        get {
            if let appConfig = Bundle.main.object(forInfoDictionaryKey: "DJCloundAppConfig") as? [String: String] {
