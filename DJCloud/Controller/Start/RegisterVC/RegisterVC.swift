...
class RegisterVC: UIViewController {
    ...
    @IBOutlet weak var viewUserSuggest: InputTextField!
    ...
    override func viewDidLoad() {
        ...
        viewUserSuggest.placeHolder = "Người giới thiệu"
    ...
    override func viewDidLayoutSubviews() {
        ...
        viewRegister.roundRectWith(corners: [.topLeft, .topRight, .bottomLeft, .bottomRight], radius: 24)
        viewRegister.layoutIfNeeded()
        viewRegister.setGradientBackground(startColor: UIColor(hex: 0x32237e), endColor: UIColor(hex: 0x7291c6), gradientDirection: .leftToRight)
    }
    ...
    @IBAction func actionRegister(_ sender: Any) {
        ...
        SigUpAPI.init(referer: viewUserSuggest.text, userName: userName, email: email, password: password, confirmPass: password).execute(target: self) { (response) in
